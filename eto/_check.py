...
"""
from util.convert import deg2rad
...
def check_latitude_rad(latitude):
    #print("check_latitude_rad:latitude => "+str(latitude)+"<=")
    #print("min rads " + str(_MINLAT_RADIANS) + " lat" + str(latitude) + " max" + str(_MAXLAT_RADIANS))
